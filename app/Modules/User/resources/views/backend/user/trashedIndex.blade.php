            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="col-12">
                            <h5 style="display: inline;">Trashed Users Table</h5>
                            <a href="{{ route('backend.user.index') }}" class="btn btn-secondary float-right ">Previous Page</a>
                        </div>
...
@push('scripts')
    <script>
        $('#global-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('backend.user.getTrashedUserData') }}",
            columns: [{
                    data: 'id',
