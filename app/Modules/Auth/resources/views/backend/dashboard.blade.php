        ...
        <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-table-three">
                ...
                <div class="widget-heading col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="">Today's Booking</h5>
                        </div>
                        <div class="col-md-6 bg-light text-right">
                            <a href="{{ route('admin.approvalLists') }}" type="button" class="btn btn-primary">All Bookings</a>
                ...
                <div class="widget-content">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div class="th-content th-heading">Venues</div>
                                    </th>
                                    <th>
                                        <div class="th-content th-heading">Application Status</div>
                                    </th>
                                    <th>
                    ...
                    <td>
                        <div class="td-content"><span class="pricing">{{ $booking->vendor->name }}</span></div>
                    </td>
                    <td>
                ...
                @empty
                    <div class="no-booking-section col-md-12 justify-content-center">
                    ...
                    <div class="summary-list">
                        ...
                        <div class="w-summary-details">
                            ...
                            <div class="w-summary-stats">
                                <div class="progress">
                                    <div class="progress-bar bg-gradient-secondary" role="progressbar" style="width: 90%"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="td-content"><span class="badge outline-badge-primary">Shipped</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="td-content"><span class="badge outline-badge-success">Paid</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
